...
wait_for_ci_success() {
  ...
  local elapsed=0
  local required_jobs_json='["Web And Docs Build (node 22)","Web And Docs Build (node 24)","Docker Build","Security Audit","Rust (ubuntu-latest)","Rust (macos-latest)","Stability Smoke","Build (Release)"]'
