...
Yes. Implement the `Tool` trait (`microclaw_tools::runtime::Tool`) under `crates/microclaw-engine/src/tools/`, register it in `ToolRegistry::new()`, and it becomes available to the LLM automatically.
