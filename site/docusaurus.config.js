...
const config = {
  title: 'MicroClaw',
  tagline: 'One shared Rust agent core for MicroClaw Server and native desktop Work.',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                label: 'Issues',
                href: 'https://github.com/microclaw/microclaw/issues',
              },
              {
                label: 'Releases',
        ...
        copyright: `Copyright © ${new Date().getFullYear()} MicroClaw.`,
      },
      prism: {
