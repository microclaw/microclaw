...
//! - SSRF pre-flight via `crate::internal::tool_runtime::url_safety::check_url_private_ip`
...
use crate::internal::tool_runtime::url_safety::check_url_private_ip;
...
fn resolve_and_guard_path(
    ...
    if crate::internal::tool_runtime::path_guard::is_blocked(&canonical) {
        return Err(format!(
