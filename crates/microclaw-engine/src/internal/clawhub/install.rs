...
use crate::internal::clawhub::gate::check_requirements;
use crate::internal::clawhub::lockfile::{is_clawhub_managed, read_lockfile, write_lockfile};
use crate::internal::clawhub::types::{LockEntry, LockFile};
...
#[cfg(test)]
mod tests {
    use crate::internal::clawhub::types::LockFile;
