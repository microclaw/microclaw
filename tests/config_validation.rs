...
fn minimal_config() -> Config {
    Config {
        ...
        web_fetch_validation:
            microclaw_engine::tool_runtime::web_content_validation::WebContentValidationConfig::default(),
        web_fetch_url_validation: microclaw_engine::tool_runtime::web_fetch::WebFetchUrlValidationConfig::default(
        ),
        web_search: microclaw_engine::tool_runtime::web_search::SearchProviderConfig::default(),
