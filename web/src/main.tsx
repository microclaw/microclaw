...
import { ConfigFieldCard } from './components/config-field-card'
import { ThreadPane, type PendingApproval } from './components/chat-thread'
import { GeneralSettingsTab, ModelSettingsTab } from './components/settings-general'
import {
  A2ASettingsTab,
  DiscordSettingsTab,
  DynamicChannelSettingsTab,
  IrcSettingsTab,
  TelegramSettingsTab,
  WebSettingsTab,
} from './components/settings-channels'
...
import { extractLatestUserText, mapBackendHistory } from './lib/chat-history'
import { toJsonObject } from './lib/json-utils'
import {
                ...
                <div className="grid h-full grid-cols-[240px_minmax(0,1fr)] gap-4">
                  <Card className="h-full p-3" style={sectionCardStyle}>
                    <Tabs.List className="mc-settings-tabs-list flex h-full w-full flex-col gap-1">
                      ...
                      <Tabs.Trigger value="learning" className="mc-settings-tab-trigger w-full justify-start rounded-lg px-3 py-2 text-[18px] leading-6 bg-transparent data-[state=active]:bg-emerald-500/20 data-[state=active]:text-emerald-200 hover:bg-white/8">📚  Learning</Tabs.Trigger>
                  ...
                  <div className="min-w-0 overflow-y-auto pr-1">
                    <GeneralSettingsTab configDraft={configDraft} setConfigField={setConfigField} sectionCardClass={sectionCardClass} sectionCardStyle={sectionCardStyle} toggleCardClass={toggleCardClass} toggleCardStyle={toggleCardStyle} />

                    <ModelSettingsTab configDraft={configDraft} setConfigField={setConfigField} sectionCardClass={sectionCardClass} sectionCardStyle={sectionCardStyle} toggleCardClass={toggleCardClass} toggleCardStyle={toggleCardStyle} providerProfileDrafts={providerProfileDrafts} nextProviderProfileHint={nextProviderProfileHint} updateProviderProfile={updateProviderProfile} addProviderProfile={addProviderProfile} cloneProviderProfile={cloneProviderProfile} removeProviderProfile={removeProviderProfile} resetRefsAndRemoveProviderProfile={resetRefsAndRemoveProviderProfile} />
                    ...
                    <Tabs.Content value="learning">
                      <div className={sectionCardClass} style={sectionCardStyle}>
                        <Text size="3" weight="bold">Learning Evidence</Text>
                        <Text size="1" color="gray" className="mt-1 block">
                          Inspect which prior experiences influenced a run and the evidence behind its outcome.
                        </Text>
                        <LearningPanel sessionKey={sessionKey} />
                      </div>
                    </Tabs.Content>
                    ...
                    <TelegramSettingsTab configDraft={configDraft} setConfigField={setConfigField} sectionCardClass={sectionCardClass} sectionCardStyle={sectionCardStyle} soulFiles={soulFiles} providerProfileDrafts={providerProfileDrafts} />

                    <DiscordSettingsTab configDraft={configDraft} setConfigField={setConfigField} sectionCardClass={sectionCardClass} sectionCardStyle={sectionCardStyle} providerProfileDrafts={providerProfileDrafts} />

                    <IrcSettingsTab configDraft={configDraft} setConfigField={setConfigField} sectionCardClass={sectionCardClass} sectionCardStyle={sectionCardStyle} providerProfileDrafts={providerProfileDrafts} />

                    {DYNAMIC_CHANNELS.map((ch) => (
                      <DynamicChannelSettingsTab key={ch.name} ch={ch} configDraft={configDraft} setConfigField={setConfigField} sectionCardClass={sectionCardClass} sectionCardStyle={sectionCardStyle} soulFiles={soulFiles} providerProfileDrafts={providerProfileDrafts} />
                    ))}

                    <WebSettingsTab configDraft={configDraft} setConfigField={setConfigField} sectionCardClass={sectionCardClass} sectionCardStyle={sectionCardStyle} configSelfCheck={configSelfCheck} />

                    <A2ASettingsTab configDraft={configDraft} setConfigField={setConfigField} sectionCardClass={sectionCardClass} sectionCardStyle={sectionCardStyle} toggleCardClass={toggleCardClass} toggleCardStyle={toggleCardStyle} updateA2APeer={updateA2APeer} addA2APeer={addA2APeer} removeA2APeer={removeA2APeer} />
