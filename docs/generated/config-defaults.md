...
| `chat_turn_serialization` | `bool` | `default_chat_turn_serialization` | `true` |
| `chat_turn_queue_strategy` | `String` | `default_chat_turn_queue_strategy` | `"queue_then_rerun".to_string()` |
| `chat_turn_queue_max_pending` | `usize` | `default_chat_turn_queue_max_pending` | `20` |
| `parallel_tool_execution` | `bool` | `serde(default)` | `false` |
